...
lab_result_spectra="/Users/zimenglyu/Documents/datasets/SOM_flight/flight_53438_10.csv"
lab_result_label="/Users/zimenglyu/Documents/datasets/SOM_flight/flight_53438_10_label.csv"
test_data="/Users/zimenglyu/Documents/datasets/SOM_flight/flight_53438_10.csv"
# test_data="/Users/zimenglyu/Documents/datasets/microbeam/PPM/Cyclone_10_March_Sampling_Spectra.csv"
...
do
    for n in 5 7 10 15
    do
    folder_name="SOM_Flight_10/$data_set/$n"  # Specify the folder path here
        ...
        for neighbor in 3 5 7 10 # not run yet
        do
