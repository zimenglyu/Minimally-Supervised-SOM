...
do
    for n in 30
    do
        result_folder_name="SOM_energy_FINAL_SORTED/filesize_$file_size/som_$n/$file"  # Specify the folder path here
        ...
        lab_result_spectra="$dataset_path/${file_size}_sorted/energydata_$file.csv"
        lab_result_label="$dataset_path/${file_size}_sorted/energydata_${file}_label.csv"
        test_data="$dataset_path/${file_size}_sorted/energydata_$file.csv"
